...
private val BASE_EN: Map<String, String> = mapOf(
    ...
    "throttle.warn" to "Your phone is capping the CPU at %d%% — that is why the game is slow.",
    "throttle.warn.samsung" to "Samsung's Game Optimizing Service is capping the CPU at %d%%.",
