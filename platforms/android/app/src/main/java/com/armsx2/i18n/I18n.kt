...
private val BASE_EN: Map<String, String> = mapOf(
    ...
    "throttle.help.title" to "Your phone is slowing the game down",
    "throttle.help.intro" to "Your phone is limiting the CPU to %d%% of its speed, and that is why the game is slow. It is not the emulator. There is a fix, and it takes about 20 seconds.",
    "throttle.help.intro.generic" to "Your phone is limiting the CPU to %d%% of its speed while the game runs, and that is why it is slow. The limit comes from the phone itself, not from the emulator, and the app cannot switch it off.",
    ...
    "throttle.help.step3" to "A small window will ask if you are sure.\n\nTap \"OK\".",
