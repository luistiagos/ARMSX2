...
- [rastreabilidade-sem-verificacao-de-git-para-task](../bugs/open/armsx2-fork/rastreabilidade-sem-verificacao-de-git-para-task_2026-08-25T22-44.md) — nada valida o sentido git → task; não há gancho
