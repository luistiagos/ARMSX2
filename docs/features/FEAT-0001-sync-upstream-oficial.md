...
| [TASK-0067](../task/TASK-0067-merge-com-o-upstream.md) | concluída | **Merge com o upstream** — 72 commits que não tínhamos, 5 conflitos; todo o GS em auto-merge. É a operação para a qual o fork foi desenhado, feita pela primeira vez |
