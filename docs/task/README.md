...
| [TASK-0088](TASK-0088-medir-sem-o-interpretador-do-art.md) — um build de debug **não-`debuggable`**, para medir sem o interpretador do ART no caminho | em andamento | — | anr-ao-abrir-o-menu-de-pausa-sob-angle, digitar-custa-97-a-450ms-por-tecla-na-thread-da-ui | `93d8ee39e8` |
| [TASK-0090](TASK-0090-duas-correcoes-de-campo-do-upstream.md) — **bloco 1**: afinidade não anula mais o Sustained Performance, e a extração para de encher o page cache | aberta | FEAT-0003 | — | — |
