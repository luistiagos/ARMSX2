...
| [TASK-0090](TASK-0090-duas-correcoes-de-campo-do-upstream.md) — **bloco 1**: afinidade não anula mais o Sustained Performance, e a extração para de encher o page cache | concluída | FEAT-0003 | — | `98d6c01402` `5a6ef7fcf2` `03f3e48a1f` `02198734e1` `33544306c2` `f343396f2b` `fd5787fee1` |
