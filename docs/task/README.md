...
| [TASK-0081](TASK-0081-nenhuma-chave-de-traducao-chega-crua-a-tela.md) — nenhuma chave de tradução chega crua à tela, e um teste passa a garantir isso | em andamento | — | chave-de-traducao-crua-na-tela | `ed46425a97` |
