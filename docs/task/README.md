...
| [TASK-0065](TASK-0065-veredito-do-renderer-em-todo-relato.md) — o veredito do renderer automático em todo relato, e a regra `auto-vulkan` registrada | em andamento | — | veredito-do-renderer-automatico-so-chega-a-relato-quando-ha-crash | `2a6fbbee39` `ec6d44c05f` |
